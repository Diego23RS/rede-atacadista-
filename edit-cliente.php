      ...
      <!--------------------------
		...
		<div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="POST" action="acoes/atualiza-cliente.php" enctype="multipart/form-data">
              <div class="box-body">
						...
						<div class="row">
							<div class="col-md-4">
								 <div class="form-group">
									  ...
									  <input type="text" class="form-control" id="nomeCompleto" value="<?php echo $xpacientes['nome']; ?>" name="nomeCompleto" placeholder="Informe o nome completo">
									  <input type="text" value="<?php echo $xpacientes['id'] ?>" class="form-control hidden" id="idCliente" name="idCliente" placeholder="ID">
									</div>
							</div>
							<div class="col-md-4">
								 <div class="form-group">
									  <label>Login <sup style="color:red">*</sup></label>
									  <input type="email" class="form-control" id="loginCliente" value="<?php echo $xpacientes['login']; ?>" name="loginCliente" placeholder="exemplo@provedor.com">
									  <input type="email" class="form-control hidden" value="<?php echo $xpacientes['login'] ?>" id="AntigologinPaciente" name="AntigologinPaciente" placeholder="exemplo@provedor.com">
									</div>
							</div>
							<div class="col-md-4">
								 <div class="form-group">
									  <label>Senha <sup style="color:red">*</sup></label>
									  <input type="password" class="form-control" id="senhaCliente" name="senhaCliente" placeholder="Digite a senha">
								</div>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-md-4">
								 <div class="form-group">
									...
									<div class="input-group date">
									  ...
									  <input type="text" name="dataNascimento" value="<?php echo $xpacientes['data_nascimento']; ?>" placeholder="00/00/0000" class="form-control pull-right" id="datepicker">
									</div>
									<!-- /.input group -->
								  </div>
							</div>
							<div class="col-md-4">
								 <div class="form-group">
									  ...
									  <input type="text" class="form-control" value="<?php echo $xpacientes['CPF']; ?>" id="CPF" name="CPF" placeholder="CPF">
									</div>
							</div>
							<div class="col-md-4">
								 <div class="form-group">
									  <label>Telefone / Whatsapp <sup style="color:red">*</sup></label>
									  <input type="text" class="form-control" id="whats" value="<?php echo $xpacientes['telefone']; ?>" name="whats" placeholder="(xx) xxxxx-xxxx">
									</div>
							</div>
              ...
              <div class="box-footer">
				<div class="row">
					...
					<div class="col-md-10">
					<button type="submit" class="btn bg-orange btn-lg"><i class="fa fa-save"></i> Atualizar</button>
					<a href="pacientes.php" class="btn btn-default btn-lg"><i class="fa fa-times"></i> Cancelar</a>
					</div>
				</div>
