...
$ext_imagem = strtolower(substr($_FILES['foto3']['name'],-4)); //Pegando extensão do arquivo
...
move_uploaded_file($_FILES['foto3']['tmp_name'], $dir_imagem.$puro_imagem); //Fazer upload do arquivo
}
	



$produto_inserir="UPDATE produtos SET foto3 = '$new_name_imagem' WHERE id = '$id'";
