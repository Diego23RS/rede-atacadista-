...
$ext_imagem = strtolower(substr($_FILES['foto2']['name'],-4)); //Pegando extensão do arquivo
...
move_uploaded_file($_FILES['foto2']['tmp_name'], $dir_imagem.$puro_imagem); //Fazer upload do arquivo
}
	



$produto_inserir="UPDATE produtos SET foto2 = '$new_name_imagem' WHERE id = '$id'";
