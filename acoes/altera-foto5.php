...
$ext_imagem = strtolower(substr($_FILES['foto5']['name'],-4)); //Pegando extensão do arquivo
...
move_uploaded_file($_FILES['foto5']['tmp_name'], $dir_imagem.$puro_imagem); //Fazer upload do arquivo
}
	



$produto_inserir="UPDATE produtos SET foto5 = '$new_name_imagem' WHERE id = '$id'";
