              ...
              <table id="example1" class="table table-bordered table-striped table-hover">
				...
				<td class="hidden" style="vertical-align: middle;">
				 ...
				 <a href="#" style="color:blue;" data-toggle="modal" data-target="#modal-transacao-<?php echo $pedidohoje['id']; ?>"><u>Cartão de Crédito <?php if($pedidohoje['status_pagamento']=="Disponível" or $pedidohoje['status_pagamento']=="Pago"){echo "<b style='color:green !important'><i class='fa fa-check-circle'></i></b>";}else{echo "<b style='color:red !important'><i class='fa fa-times'></i></b>";}?> </u></a>
				  ...
				  <td style="vertical-align: middle;">
				  <?php if ($pedidohoje['status_pedido']=='Aguardando'){ ?>
				   <div class="bg-gray" style="border-radius:25px;padding:5px;"><center><h4>Aguardando</h4></center></div>
				   <?php }?>
				   
				   <?php if ($pedidohoje['status_pedido']=='Aprovado'){ ?>
				   <div class="bg-green" style="border-radius:25px;padding:5px;"><center><h4>Aprovado</h4></center></div>
				   <?php }?>
				   
				   <?php if ($pedidohoje['status_pedido']=='Cancelado'){ ?>
				  <div class="bg-red" style="border-radius:25px;padding:5px;"><center><h4>Cancelado</h4></center></div>
				   <?php }?>
				   
				   <?php if ($pedidohoje['status_pedido']=='Separacao'){ ?>
				   <div class="bg-navy" style="border-radius:25px;padding:5px;"><center><h4>Separacao</h4></center></div>
				   <?php }?>
				   
				   <?php if ($pedidohoje['status_pedido']=='Entrega'){ ?>
				   <div style="border-radius:25px;padding:5px;background:yellow; color:black"><center><h4>Entrega</h4></center></div>
				   <?php }?>
				   
				   <?php if ($pedidohoje['status_pedido']=='Finalizado'){ ?>
				   <div style="border-radius:25px;padding:5px;background:black; color:white"><center><h4><i class="fa fa-check-circle"></i> Finalizado</h4></center></div>
				   <?php }?>
				   
				  </td>
				  <td style="vertical-align: middle;">
				   <select class="form-control" style="width:100%" id="mudaStatusHoje_<?php echo $pedidohoje['id']; ?>">
					  <option value="">Alterar Status</option>
					  <option value="Aguardando" <?php if ($pedidohoje['status_pedido']=="Aguardando"){echo "class='hidden'";}?> >Aguardando</option>
					  <option value="Aprovado" <?php if ($pedidohoje['status_pedido']=="Aprovado"){echo "class='hidden'";}?>>Aprovado</option>
					  <option value="Cancelado" <?php if ($pedidohoje['status_pedido']=="Cancelado"){echo "class='hidden'";}?>>Cancelado</option>
					  <option value="Separacao" <?php if ($pedidohoje['status_pedido']=="separacao"){echo "class='hidden'";}?>>Separacao</option>
					  <option value="Entrega" <?php if ($pedidohoje['status_pedido']=="Entrega"){echo "class='hidden'";}?>>Entrega</option>
					  <option value="Finalizado" <?php if ($pedidohoje['status_pedido']=="Finalizado"){echo "class='hidden'";}?>>Finalizado</option>
					</select>
				  </td>
                </tr>
               ...
               <thead>
				...
				<?php echo $apedidohoje['data_pedido'];  ?>
				 ...
				 <a href="#" style="color:blue;" data-toggle="modal" data-target="#modal-transacao-<?php echo $apedidohoje['id']; ?>"><u>Cartão de Crédito <?php if($apedidohoje['status_pagamento']=="Disponível" or $apedidohoje['status_pagamento']=="Pago"){echo "<b style='color:green !important'><i class='fa fa-check-circle'></i></b>";}else{echo "<b style='color:red !important'><i class='fa fa-times'></i></b>";}?> </u></a>
				  ...
				  <td style="vertical-align: middle;">
				  <?php if ($apedidohoje['status_pedido']=='Aguardando'){ ?>
				   <div class="bg-gray" style="border-radius:25px;padding:5px;"><center><h4>Aguardando</h4></center></div>
				   <?php }?>
				   
				   <?php if ($apedidohoje['status_pedido']=='Aprovado'){ ?>
				   <div class="bg-green" style="border-radius:25px;padding:5px;"><center><h4>Aprovado</h4></center></div>
				   <?php }?>
				   
				   <?php if ($apedidohoje['status_pedido']=='Cancelado'){ ?>
				  <div class="bg-red" style="border-radius:25px;padding:5px;"><center><h4>Cancelado</h4></center></div>
				   <?php }?>
				   
				   <?php if ($apedidohoje['status_pedido']=='Separacao'){ ?>
				   <div class="bg-navy" style="border-radius:25px;padding:5px;"><center><h4>Separacao</h4></center></div>
				   <?php }?>
				   
				   <?php if ($apedidohoje['status_pedido']=='Entrega'){ ?>
				   <div style="border-radius:25px;padding:5px;background:yellow; color:black"><center><h4>Entrega</h4></center></div>
				   <?php }?>
				   
				   <?php if ($apedidohoje['status_pedido']=='Finalizado'){ ?>
				   <div style="border-radius:25px;padding:5px;background:black; color:white"><center><h4><i class="fa fa-check-circle"></i> Finalizado</h4></center></div>
				   <?php }?>
				   
				  </td>
				  <td style="vertical-align: middle;">
				   <select class="form-control" style="width:100%" id="mudaStatusHoje_<?php echo $apedidohoje['id']; ?>">
					  <option value="">Alterar Status</option>
					  <option value="Aguardando" <?php if ($apedidohoje['status_pedido']=="Aguardando"){echo "class='hidden'";}?> >Aguardando</option>
					  <option value="Aprovado" <?php if ($apedidohoje['status_pedido']=="Aprovado"){echo "class='hidden'";}?>>Aprovado</option>
					  <option value="Cancelado" <?php if ($apedidohoje['status_pedido']=="Cancelado"){echo "class='hidden'";}?>>Cancelado</option>
					  <option value="Separacao" <?php if ($apedidohoje['status_pedido']=="separacao"){echo "class='hidden'";}?>>Separacao</option>
					  <option value="Entrega" <?php if ($apedidohoje['status_pedido']=="Entrega"){echo "class='hidden'";}?>>Entrega</option>
					  <option value="Finalizado" <?php if ($apedidohoje['status_pedido']=="Finalizado"){echo "class='hidden'";}?>>Finalizado</option>
					</select>
				  </td>
                </tr>
